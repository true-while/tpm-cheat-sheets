...
| --- | --- | --- | --- | --- | --- | --- | --- |
| **Title** | GitHub Foundations | GitHub Fundamentals - Administration basics and product features | Automate your workflow with GitHub Actions | GitHub - Copilot Fundamentals |  GitHub - Advanced Security | DevOps foundations: The core principles and practices |  |
