...
| **Duration** | 1-day | 1-day | 1-day | 1-day | 1-day  | 1-day  | 4-day | 
| **Labs** | 11 exercises from Learn  | 5 exercises from Learn | 7 exercises from Learn | 10 exercises from Learn | 6 exercises from Learn | [4 Labs](https://microsoftlearning.github.io/AZ-2008_DevOps_Foundations_Core_Principles_Practices/) | [12 Labs](https://github.com/MicrosoftLearning/AZ400-DesigningandImplementingMicrosoftDevOpsSolutions) |
| **Audience** | All roles | Devs, DevOps, Architects| DevOps | Devs, DevOps, AI engineers | DevOps, Security engines | IT-Pro, Devs | IT-Pro, Devs | 
...
| **Pre-requisites** | - | Reops, Pipelines, IDEs | Pipelines, YAML, Repos | Dev exp, C# & Python. | DevOps, Pipelines  | No dev exp required | Pipelines, YAML, Repos |
