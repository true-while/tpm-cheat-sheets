...
| **Pre-requisites** | Azure Portal | Azure Portal | Azure Portal | SAP HANA or SAP NetWeaver | Azure CLI, RBAC, OS on Linux kernel | AD DS, Windows servers. | Entra ID, Azure Policy, vNets, CLI |
