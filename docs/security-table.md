...
| **Pre-req class** | SC-900 | SC-900 | SC-900 | SC-900 | SC-900 | SC-900  |  |  
| **Pre-requisites** | VMs, VNets, Scripting | VNets, Thread Modeling. Hybrid. | Basic Purview, M365 | MS Defender for endpoints, KQL | MS Defender, Sentinel, Purview | M365, Purview |  |  
